 ...
 */
package com.google.android.exoplayer2internal.analytics;
...
import com.google.android.exoplayer2internal.Player;
import com.google.android.exoplayer2internal.Timeline;
import com.google.android.exoplayer2internal.source.MediaSource;
import com.google.android.exoplayer2internal.source.ads.AdPlaybackState;
...
public final class DefaultPlaybackSessionManagerTest {
  ...
  public void updateSessions_withoutMediaPeriodId_createsNewSession() {
    ...
    AnalyticsListener.EventTime eventTime = createEventTime(timeline, /* windowIndex= */ 0, /* mediaPeriodId */ null);
  ...
  public void updateSessions_withMediaPeriodId_createsNewSession() {
    ...
    AnalyticsListener.EventTime eventTime = createEventTime(timeline, /* windowIndex= */ 0, mediaPeriodId);
  ...
  public void
    ...
    MediaSource.MediaPeriodId mediaPeriodId =
        new MediaSource.MediaPeriodId(
            timeline.getUidOfPeriod(/* periodIndex= */ 0), /* windowSequenceNumber= */ 0);
    AnalyticsListener.EventTime eventTime1 =
        createEventTime(timeline, /* windowIndex= */ 0, /* mediaPeriodId= */ null);
    AnalyticsListener.EventTime eventTime2 = createEventTime(timeline, /* windowIndex= */ 0, mediaPeriodId);
  ...
  public void
    ...
    MediaSource.MediaPeriodId mediaPeriodId =
        new MediaSource.MediaPeriodId(
            timeline.getUidOfPeriod(/* periodIndex= */ 0), /* windowSequenceNumber= */ 0);
    AnalyticsListener.EventTime eventTime1 = createEventTime(timeline, /* windowIndex= */ 0, mediaPeriodId);
  ...
  public void updateSessions_ofSameWindow_withoutMediaPeriodId_afterAd_doesNotCreateNewSession() {
    ...
    MediaSource.MediaPeriodId adMediaPeriodId =
        new MediaSource.MediaPeriodId(
            timeline.getUidOfPeriod(/* periodIndex= */ 0),
            /* adGroupIndex= */ 0,
            /* adIndexInAdGroup= */ 0,
            /* windowSequenceNumber= */ 0);
    MediaSource.MediaPeriodId contentMediaPeriodIdDuringAd =
        new MediaSource.MediaPeriodId(
            timeline.getUidOfPeriod(/* periodIndex= */ 0),
            /* windowSequenceNumber= */ 0,
            /* nextAdGroupIndex= */ 0);
    AnalyticsListener.EventTime adEventTime = createEventTime(timeline, /* windowIndex= */ 0, adMediaPeriodId);
    AnalyticsListener.EventTime contentEventTimeDuringAd =
        createEventTime(
            timeline, /* windowIndex= */ 0, contentMediaPeriodIdDuringAd, adMediaPeriodId);
    AnalyticsListener.EventTime contentEventTimeWithoutMediaPeriodId =
        createEventTime(timeline, /* windowIndex= */ 0, /* mediaPeriodId= */ null);
  ...
  public void updateSessions_withOtherMediaPeriodId_ofSameWindow_doesNotCreateNewSession() {
    ...
    AnalyticsListener.EventTime eventTime1 = createEventTime(timeline, /* windowIndex= */ 0, mediaPeriodId1);
    AnalyticsListener.EventTime eventTime2 = createEventTime(timeline, /* windowIndex= */ 0, mediaPeriodId2);
  ...
  public void
    ...
    MediaSource.MediaPeriodId mediaPeriodId2 =
        new MediaSource.MediaPeriodId(
            timeline.getUidOfPeriod(/* periodIndex= */ 0), /* windowSequenceNumber= */ 1);
    MediaSource.MediaPeriodId mediaPeriodIdWithAd =
        new MediaSource.MediaPeriodId(
            timeline.getUidOfPeriod(/* periodIndex= */ 0),
            /* adGroupIndex= */ 0,
            /* adIndexInAdGroup= */ 0,
    ...
    AnalyticsListener.EventTime eventTime1 = createEventTime(timeline, /* windowIndex= */ 0, mediaPeriodId1);
    AnalyticsListener.EventTime eventTime2 = createEventTime(timeline, /* windowIndex= */ 0, mediaPeriodId2);
    AnalyticsListener.EventTime eventTime3 = createEventTime(timeline, /* windowIndex= */ 0, mediaPeriodIdWithAd);
    AnalyticsListener.EventTime eventTime4 =
        createEventTime(timeline, /* windowIndex= */ 0, /* mediaPeriodId= */ null);
  ...
  public void
    ...
    AnalyticsListener.EventTime adEventTime1 =
        createEventTime(
            adTimeline,
            /* windowIndex= */ 0,
            new MediaSource.MediaPeriodId(
                ...
                /* adIndexInAdGroup= */ 0,
                /* windowSequenceNumber= */ 0));
    AnalyticsListener.EventTime adEventTime2 =
        createEventTime(
            adTimeline,
            /* windowIndex= */ 0,
            new MediaSource.MediaPeriodId(
                ...
                /* adIndexInAdGroup= */ 0,
                /* windowSequenceNumber= */ 0));
    AnalyticsListener.EventTime contentEventTime1 =
        createEventTime(
            adTimeline,
            /* windowIndex= */ 0,
            new MediaSource.MediaPeriodId(
                ...
                /* windowSequenceNumber= */ 0,
                /* nextAdGroupIndex= */ 0));
    AnalyticsListener.EventTime contentEventTime2 =
        createEventTime(
            adTimeline,
            /* windowIndex= */ 0,
            new MediaSource.MediaPeriodId(
  ...
  public void belongsToSession_withSameWindowIndex_returnsTrue() {
    ...
    Timeline timeline = new FakeTimeline(/* windowCount= */ 1);
    AnalyticsListener.EventTime eventTimeWithTimeline =
        createEventTime(timeline, /* windowIndex= */ 0, /* mediaPeriodId= */ null);
    MediaSource.MediaPeriodId mediaPeriodId =
        new MediaSource.MediaPeriodId(
            timeline.getUidOfPeriod(/* periodIndex= */ 0), /* windowSequenceNumber= */ 0);
    AnalyticsListener.EventTime eventTimeWithMediaPeriodId =
  ...
  public void belongsToSession_withOtherWindowIndex_returnsFalse() {
    AnalyticsListener.EventTime eventTime =
        createEventTime(Timeline.EMPTY, /* windowIndex= */ 0, /* mediaPeriodId= */ null);
    AnalyticsListener.EventTime eventTimeOtherWindow =
        createEventTime(Timeline.EMPTY, /* windowIndex= */ 1, /* mediaPeriodId= */ null);
    Timeline timeline = new FakeTimeline(/* windowCount= */ 2);
    MediaSource.MediaPeriodId mediaPeriodId =
        new MediaSource.MediaPeriodId(
            timeline.getUidOfPeriod(/* periodIndex= */ 1), /* windowSequenceNumber= */ 1);
    AnalyticsListener.EventTime eventTimeWithOtherMediaPeriodId =
  ...
  public void initialTimelineUpdate_finishesAllSessionsOutsideTimeline() {
    ...
    sessionManager.updateSessions(eventTime2);
    Timeline timeline = new FakeTimeline(/* windowCount= */ 1);
    AnalyticsListener.EventTime newTimelineEventTime =
        createEventTime(timeline, /* windowIndex= */ 0, /* mediaPeriodId= */ null);
  ...
  public void dynamicTimelineUpdate_resolvesWindowIndices() {
    ...
    AnalyticsListener.EventTime eventForInitialTimelineId100 =
        createEventTime(
            initialTimeline,
            /* windowIndex= */ 0,
            new MediaSource.MediaPeriodId(
                ...
                /* windowSequenceNumber= */ 0));
    AnalyticsListener.EventTime eventForInitialTimelineId200 =
        createEventTime(
            initialTimeline,
            /* windowIndex= */ 1,
            new MediaSource.MediaPeriodId(
                ...
                /* windowSequenceNumber= */ 1));
    AnalyticsListener.EventTime eventForInitialTimelineId300 =
        createEventTime(
            initialTimeline,
            /* windowIndex= */ 2,
            new MediaSource.MediaPeriodId(
    ...
    AnalyticsListener.EventTime eventForTimelineUpdateId100 =
        createEventTime(
            timelineUpdate,
            /* windowIndex= */ 1,
            new MediaSource.MediaPeriodId(
                ...
                /* windowSequenceNumber= */ 0));
    AnalyticsListener.EventTime eventForTimelineUpdateId300 =
        createEventTime(
            timelineUpdate,
            /* windowIndex= */ 0,
            new MediaSource.MediaPeriodId(
        ...
        new FakeTimeline(
            new TimelineWindowDefinition(
                ...
                new AdPlaybackState(/* adGroupTimesUs=... */ C.TIME_END_OF_SOURCE)
                    .withAdCount(/* adGroupIndex= */ 0, /* adCount= */ 1)));
    AnalyticsListener.EventTime adEventTime =
        createEventTime(
            adTimeline,
            /* windowIndex= */ 0,
            new MediaSource.MediaPeriodId(
  ...
  public void positionDiscontinuity_toNewWindow_finishesOnlyPastSessions() {
    ...
    AnalyticsListener.EventTime eventTime2 =
        createEventTime(
            ...
            new MediaSource.MediaPeriodId(
                timeline.getUidOfPeriod(/* periodIndex= */ 1), /* windowSequenceNumber= */ 1));
    AnalyticsListener.EventTime eventTime3 =
        createEventTime(
            timeline,
            /* windowIndex= */ 2,
            new MediaSource.MediaPeriodId(
    ...
    AnalyticsListener.EventTime adEventTime2 =
        createEventTime(
            ...
            new MediaSource.MediaPeriodId(
                ...
                /* adIndexInAdGroup= */ 0,
                /* windowSequenceNumber= */ 0));
    AnalyticsListener.EventTime contentEventTimeDuringPreroll =
        createEventTime(
            adTimeline,
            /* windowIndex= */ 0,
            /* eventMediaPeriodId= */ new MediaSource.MediaPeriodId(
                adTimeline.getUidOfPeriod(/* periodIndex= */ 0),
                /* windowSequenceNumber= */ 0,
                /* nextAdGroupIndex= */ 0),
            /* currentMediaPeriodId= */ new MediaSource.MediaPeriodId(
                adTimeline.getUidOfPeriod(/* periodIndex= */ 0),
                /* adGroupIndex= */ 0,
                /* adIndexInAdGroup= */ 0,
                /* windowSequenceNumber= */ 0));
    AnalyticsListener.EventTime contentEventTimeBetweenAds =
        createEventTime(
            adTimeline,
            /* windowIndex= */ 0,
            new MediaSource.MediaPeriodId(
  ...
  public void finishAllSessions_callsOnSessionFinishedForAllCreatedSessions() {
    ...
    AnalyticsListener.EventTime eventTimeWindow0 =
        createEventTime(timeline, /* windowIndex= */ 0, /* mediaPeriodId= */ null);
    AnalyticsListener.EventTime eventTimeWindow2 =
    ...
    AnalyticsListener.EventTime finishEventTime =
        createEventTime(Timeline.EMPTY, /* windowIndex= */ 0, /* mediaPeriodId= */ null);
  ...
  private static AnalyticsListener.EventTime createEventTime(
  ...
  private static AnalyticsListener.EventTime createEventTime(
      Timeline timeline,
      int windowIndex,
      @Nullable MediaSource.MediaPeriodId eventMediaPeriodId,
