...
import com.google.android.exoplayer2internal.source.SinglePeriodTimeline;
...
public final class AdsMediaSourceTest {
  ...
  @Mock private MediaSource.MediaSourceCaller mockMediaSourceCaller;
  ...
  public void setUp() {
    ...
    AdsLoader.AdViewProvider mockAdViewProvider = mock(AdsLoader.AdViewProvider.class);
    ArgumentCaptor<AdsLoader.EventListener> eventListenerArgumentCaptor =
  ...
  public void createPeriod_createsChildPrerollAdMediaPeriod() {
    ...
    prerollAdMediaSource.assertMediaPeriodCreated(
        new MediaSource.MediaPeriodId(PREROLL_AD_PERIOD_UID, /* windowSequenceNumber= */ 0));
  }
  ...
  public void createPeriod_createsChildContentMediaPeriod() {
    ...
    shadowOf(Looper.getMainLooper()).idle();
    adsMediaSource.createPeriod(
        new MediaSource.MediaPeriodId(CONTENT_PERIOD_UID, /* windowSequenceNumber= */ 0),
        mock(Allocator.class),
        /* startPositionUs= */ 0);
