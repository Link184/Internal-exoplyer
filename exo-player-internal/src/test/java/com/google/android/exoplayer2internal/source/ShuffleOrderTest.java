...
public final class ShuffleOrderTest {
  ...
  public void defaultShuffleOrder() {
    assertShuffleOrderCorrectness(new ShuffleOrder.DefaultShuffleOrder(0, RANDOM_SEED), 0);
    assertShuffleOrderCorrectness(new ShuffleOrder.DefaultShuffleOrder(1, RANDOM_SEED), 1);
    assertShuffleOrderCorrectness(new ShuffleOrder.DefaultShuffleOrder(5, RANDOM_SEED), 5);
    for (int initialLength = 0; initialLength < 4; initialLength++) {
      for (int insertionPoint = 0; insertionPoint <= initialLength; insertionPoint += 2) {
        testCloneAndInsert(new ShuffleOrder.DefaultShuffleOrder(initialLength, RANDOM_SEED), insertionPoint, 0);
        testCloneAndInsert(new ShuffleOrder.DefaultShuffleOrder(initialLength, RANDOM_SEED), insertionPoint, 1);
        testCloneAndInsert(new ShuffleOrder.DefaultShuffleOrder(initialLength, RANDOM_SEED), insertionPoint, 5);
      }
    }
    testCloneAndRemove(new ShuffleOrder.DefaultShuffleOrder(5, RANDOM_SEED), 0, 1);
    testCloneAndRemove(new ShuffleOrder.DefaultShuffleOrder(5, RANDOM_SEED), 2, 3);
    testCloneAndRemove(new ShuffleOrder.DefaultShuffleOrder(5, RANDOM_SEED), 4, 5);
    testCloneAndRemove(new ShuffleOrder.DefaultShuffleOrder(1, RANDOM_SEED), 0, 1);
    testCloneAndRemove(new ShuffleOrder.DefaultShuffleOrder(1000, RANDOM_SEED), 0, 1000);
    testCloneAndRemove(new ShuffleOrder.DefaultShuffleOrder(1000, RANDOM_SEED), 0, 999);
    testCloneAndRemove(new ShuffleOrder.DefaultShuffleOrder(1000, RANDOM_SEED), 0, 500);
    testCloneAndRemove(new ShuffleOrder.DefaultShuffleOrder(1000, RANDOM_SEED), 100, 600);
    testCloneAndRemove(new ShuffleOrder.DefaultShuffleOrder(1000, RANDOM_SEED), 500, 1000);
  }

  @Test
  public void defaultShuffleOrderSideloaded() {
    int[] shuffledIndices = new int[] {2, 1, 0, 4, 3};
    ShuffleOrder shuffleOrder = new ShuffleOrder.DefaultShuffleOrder(shuffledIndices, RANDOM_SEED);
  ...
  public void unshuffledShuffleOrder() {
    assertShuffleOrderCorrectness(new ShuffleOrder.UnshuffledShuffleOrder(0), 0);
    assertShuffleOrderCorrectness(new ShuffleOrder.UnshuffledShuffleOrder(1), 1);
    assertShuffleOrderCorrectness(new ShuffleOrder.UnshuffledShuffleOrder(5), 5);
    for (int initialLength = 0; initialLength < 4; initialLength++) {
      for (int insertionPoint = 0; insertionPoint <= initialLength; insertionPoint += 2) {
        testCloneAndInsert(new ShuffleOrder.UnshuffledShuffleOrder(initialLength), insertionPoint, 0);
        testCloneAndInsert(new ShuffleOrder.UnshuffledShuffleOrder(initialLength), insertionPoint, 1);
        testCloneAndInsert(new ShuffleOrder.UnshuffledShuffleOrder(initialLength), insertionPoint, 5);
      }
    }
    testCloneAndRemove(new ShuffleOrder.UnshuffledShuffleOrder(5), 0, 1);
    testCloneAndRemove(new ShuffleOrder.UnshuffledShuffleOrder(5), 2, 3);
    testCloneAndRemove(new ShuffleOrder.UnshuffledShuffleOrder(5), 4, 5);
    testCloneAndRemove(new ShuffleOrder.UnshuffledShuffleOrder(1), 0, 1);
    testCloneAndRemove(new ShuffleOrder.UnshuffledShuffleOrder(1000), 0, 1000);
    testCloneAndRemove(new ShuffleOrder.UnshuffledShuffleOrder(1000), 0, 999);
    testCloneAndRemove(new ShuffleOrder.UnshuffledShuffleOrder(1000), 0, 500);
    testCloneAndRemove(new ShuffleOrder.UnshuffledShuffleOrder(1000), 100, 600);
    testCloneAndRemove(new ShuffleOrder.UnshuffledShuffleOrder(1000), 500, 1000);
  }

  @Test
  public void unshuffledShuffleOrderIsUnshuffled() {
    ShuffleOrder shuffleOrder = new ShuffleOrder.UnshuffledShuffleOrder(5);
  ...
  private static void assertShuffleOrderCorrectness(ShuffleOrder shuffleOrder, int length) {
    ...
    if (length == 0) {
      assertThat(shuffleOrder.getFirstIndex()).isEqualTo(C.INDEX_UNSET);
      assertThat(shuffleOrder.getLastIndex()).isEqualTo(C.INDEX_UNSET);
    } else {
      int[] indices = new int[length];
      indices[0] = shuffleOrder.getFirstIndex();
      assertThat(shuffleOrder.getPreviousIndex(indices[0])).isEqualTo(C.INDEX_UNSET);
      ...
      assertThat(shuffleOrder.getNextIndex(indices[length - 1])).isEqualTo(C.INDEX_UNSET);
