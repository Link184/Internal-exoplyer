...
import com.google.android.exoplayer2internal.metadata.flac.VorbisComment;
...
public class FlacMetadataReaderTest {
  ...
  public void readMetadataBlock_updatesReadPositionAndAlignsPeekPosition() throws Exception {
    ...
    FlacMetadataReader.readMetadataBlock(
        input, new FlacMetadataReader.FlacStreamMetadataHolder(/* flacStreamMetadata= */ null));
  ...
  public void readMetadataBlock_streamInfoBlock_setsStreamMetadata() throws Exception {
    ...
    FlacMetadataReader.FlacStreamMetadataHolder metadataHolder =
        new FlacMetadataReader.FlacStreamMetadataHolder(/* flacStreamMetadata= */ null);
  ...
  public void readMetadataBlock_seekTableBlock_updatesStreamMetadata() throws Exception {
    ...
    FlacMetadataReader.FlacStreamMetadataHolder metadataHolder = new FlacMetadataReader.FlacStreamMetadataHolder(buildStreamMetadata());
