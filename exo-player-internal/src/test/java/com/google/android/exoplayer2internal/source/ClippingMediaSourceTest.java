...
public final class ClippingMediaSourceTest {
  ...
  public void clippingUnseekableWindowThrows() throws IOException {
    ...
    try {
      ...
      assertThat(e.reason).isEqualTo(ClippingMediaSource.IllegalClippingException.REASON_NOT_SEEKABLE_TO_START);
    }
  }
  ...
  public void clippingStartAndEndInitial() throws IOException {
    ...
    Timeline timeline = new MaskingMediaSource.PlaceholderTimeline(MediaItem.fromUri(Uri.EMPTY));
