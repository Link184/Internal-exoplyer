...
public final class ConcatenatingMediaSourceTest {
  ...
  public void customCallbackIsCalledAfterRelease() throws Exception {
    ...
    try {
      testThread.runOnMainThread(
          () -> {
            MediaSource.MediaSourceCaller caller = mock(MediaSource.MediaSourceCaller.class);
  ...
  public void periodCreationWithAds() throws IOException, InterruptedException {
    ...
    mediaSourceContentOnly.assertMediaPeriodCreated(
        new MediaSource.MediaPeriodId(timelineContentOnlyPeriodUid0, /* windowSequenceNumber= */ 0));
    mediaSourceContentOnly.assertMediaPeriodCreated(
        new MediaSource.MediaPeriodId(timelineContentOnlyPeriodUid1, /* windowSequenceNumber= */ 0));
    mediaSourceWithAds.assertMediaPeriodCreated(
        new MediaSource.MediaPeriodId(timelineWithAdsPeriodUid0, /* windowSequenceNumber= */ 1));
    mediaSourceWithAds.assertMediaPeriodCreated(
        new MediaSource.MediaPeriodId(timelineWithAdsPeriodUid1, /* windowSequenceNumber= */ 1));
    mediaSourceWithAds.assertMediaPeriodCreated(
        new MediaSource.MediaPeriodId(
  ...
  public void duplicateMediaSources() throws IOException, InterruptedException {
    ...
    assertThat(childSource.getCreatedMediaPeriods())
        .containsAtLeast(
            new MediaSource.MediaPeriodId(childPeriodUid0, /* windowSequenceNumber= */ 0),
            new MediaSource.MediaPeriodId(childPeriodUid0, /* windowSequenceNumber= */ 2),
            new MediaSource.MediaPeriodId(childPeriodUid0, /* windowSequenceNumber= */ 4),
            new MediaSource.MediaPeriodId(childPeriodUid0, /* windowSequenceNumber= */ 6),
            new MediaSource.MediaPeriodId(childPeriodUid1, /* windowSequenceNumber= */ 1),
            new MediaSource.MediaPeriodId(childPeriodUid1, /* windowSequenceNumber= */ 3),
            new MediaSource.MediaPeriodId(childPeriodUid1, /* windowSequenceNumber= */ 5),
            new MediaSource.MediaPeriodId(childPeriodUid1, /* windowSequenceNumber= */ 7));
  ...
  public void duplicateNestedMediaSources() throws IOException, InterruptedException {
    ...
    assertThat(childSource.getCreatedMediaPeriods())
        .containsAtLeast(
            new MediaSource.MediaPeriodId(childPeriodUid, /* windowSequenceNumber= */ 0),
            new MediaSource.MediaPeriodId(childPeriodUid, /* windowSequenceNumber= */ 1),
            new MediaSource.MediaPeriodId(childPeriodUid, /* windowSequenceNumber= */ 2),
            new MediaSource.MediaPeriodId(childPeriodUid, /* windowSequenceNumber= */ 3),
            new MediaSource.MediaPeriodId(childPeriodUid, /* windowSequenceNumber= */ 4));
  ...
  private void assertCompletedAllMediaPeriodLoads(Timeline timeline) {
    ...
    ArrayList<MediaSource.MediaPeriodId> expectedMediaPeriodIds = new ArrayList<>();
    for (int windowIndex = 0; windowIndex < timeline.getWindowCount(); windowIndex++) {
      ...
      for (int periodIndex = window.firstPeriodIndex;
        ...
        expectedMediaPeriodIds.add(new MediaSource.MediaPeriodId(periodUid, windowIndex));
        for (int adGroupIndex = 0; adGroupIndex < period.getAdGroupCount(); adGroupIndex++) {
          for (int adIndex = 0; adIndex < period.getAdCountInAdGroup(adGroupIndex); adIndex++) {
            expectedMediaPeriodIds.add(
                new MediaSource.MediaPeriodId(periodUid, adGroupIndex, adIndex, windowIndex));
          }
        }
      }
    }
    testRunner.assertCompletedMediaPeriodLoads(
        expectedMediaPeriodIds.toArray(new MediaSource.MediaPeriodId[0]));
  }
