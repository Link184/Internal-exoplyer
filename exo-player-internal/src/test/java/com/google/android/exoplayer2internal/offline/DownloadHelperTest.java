...
public class DownloadHelperTest {
  ...
  public void getMappedTrackInfo_returnsMappedTrackInfo() throws Exception {
    ...
    MappingTrackSelector.MappedTrackInfo mappedTracks0 = downloadHelper.getMappedTrackInfo(/* periodIndex= */ 0);
    MappingTrackSelector.MappedTrackInfo mappedTracks1 = downloadHelper.getMappedTrackInfo(/* periodIndex= */ 1);
