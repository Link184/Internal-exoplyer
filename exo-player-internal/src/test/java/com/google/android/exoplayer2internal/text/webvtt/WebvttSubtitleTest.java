 ...
 */
package com.google.android.exoplayer2internal.text.webvtt;
...
public class WebvttSubtitleTest {
  ...
  public void simpleSubtitleEventIndices() {
    ...
    assertThat(simpleSubtitle.getNextEventTimeIndex(4_000_000)).isEqualTo(C.INDEX_UNSET);
    assertThat(simpleSubtitle.getNextEventTimeIndex(4_500_000)).isEqualTo(C.INDEX_UNSET);
    assertThat(simpleSubtitle.getNextEventTimeIndex(MAX_VALUE)).isEqualTo(C.INDEX_UNSET);
  }
  ...
  public void overlappingSubtitleEventIndices() {
    ...
    // Test null event (i.e. look for events after the last event)
    assertThat(overlappingSubtitle.getNextEventTimeIndex(4_000_000)).isEqualTo(C.INDEX_UNSET);
    assertThat(overlappingSubtitle.getNextEventTimeIndex(4_500_000)).isEqualTo(C.INDEX_UNSET);
    assertThat(overlappingSubtitle.getNextEventTimeIndex(MAX_VALUE)).isEqualTo(C.INDEX_UNSET);
  }
  ...
  public void nestedSubtitleEventIndices() {
    ...
    // Test null event (i.e. look for events after the last event)
    assertThat(nestedSubtitle.getNextEventTimeIndex(4_000_000)).isEqualTo(C.INDEX_UNSET);
    assertThat(nestedSubtitle.getNextEventTimeIndex(4_500_000)).isEqualTo(C.INDEX_UNSET);
    assertThat(nestedSubtitle.getNextEventTimeIndex(MAX_VALUE)).isEqualTo(C.INDEX_UNSET);
  }
