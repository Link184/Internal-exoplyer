...
import com.google.android.exoplayer2internal.source.ads.SinglePeriodAdTimeline;
...
public final class MediaPeriodQueueTest {
  ...
  private void assertGetNextMediaPeriodInfoReturnsContentMediaPeriod(
    ...
    assertThat(getNextMediaPeriodInfo())
        .isEqualTo(
            new MediaPeriodInfo(
                new MediaSource.MediaPeriodId(periodUid, /* windowSequenceNumber= */ 0, nextAdGroupIndex),
                startPositionUs,
