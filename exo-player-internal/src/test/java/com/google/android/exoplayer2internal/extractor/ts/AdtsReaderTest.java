...
public class AdtsReaderTest {
  ...
  public void setUp() throws Exception {
    ...
    TsPayloadReader.TrackIdGenerator idGenerator = new TsPayloadReader.TrackIdGenerator(0, 1);
  ...
  private void maybeStartPacket() {
    if (firstFeed) {
      adtsReader.packetStarted(0, TsPayloadReader.FLAG_DATA_ALIGNMENT_INDICATOR);
      firstFeed = false;
    }
  }
