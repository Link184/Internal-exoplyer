...
import com.google.android.exoplayer2internal.PlaybackParameters;
import com.google.android.exoplayer2internal.Player;
import com.google.android.exoplayer2internal.Renderer;
import com.google.android.exoplayer2internal.RenderersFactory;
import com.google.android.exoplayer2internal.SimpleExoPlayer;
...
import com.google.android.exoplayer2internal.drm.DefaultDrmSessionManager;
...
import com.google.android.exoplayer2internal.drm.ExoMediaDrm;
import com.google.android.exoplayer2internal.drm.MediaDrmCallback;
import com.google.android.exoplayer2internal.drm.MediaDrmCallbackException;
...
public final class AnalyticsCollectorTest {
  ...
  public void seekBackAfterReadingAhead() throws Exception {
    ...
    long periodDurationMs =
        SINGLE_PERIOD_TIMELINE.getWindow(/* windowIndex= */ 0, new Timeline.Window()).getDurationMs();
    ActionSchedule actionSchedule =
        new ActionSchedule.Builder(TAG)
            .pause()
  ...
  public void adPlayback() throws Exception {
    ...
    EventWindowAndPeriodId contentAfterPreroll =
        new EventWindowAndPeriodId(
            /* windowIndex= */ 0,
            new MediaSource.MediaPeriodId(periodUid, /* windowSequenceNumber= */ 0, /* nextAdGroupIndex= */ 1));
    EventWindowAndPeriodId contentAfterMidroll =
        new EventWindowAndPeriodId(
            /* windowIndex= */ 0,
            new MediaSource.MediaPeriodId(periodUid, /* windowSequenceNumber= */ 0, /* nextAdGroupIndex= */ 2));
  ...
  public void seekAfterMidroll() throws Exception {
    ...
    EventWindowAndPeriodId contentBeforeMidroll =
        new EventWindowAndPeriodId(
            /* windowIndex= */ 0,
            new MediaSource.MediaPeriodId(periodUid, /* windowSequenceNumber= */ 0, /* nextAdGroupIndex= */ 0));
    EventWindowAndPeriodId contentAfterMidroll =
        new EventWindowAndPeriodId(
            /* windowIndex= */ 0,
            new MediaSource.MediaPeriodId(
  ...
  private static final class EventWindowAndPeriodId {
    ...
    public EventWindowAndPeriodId(int windowIndex, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {
