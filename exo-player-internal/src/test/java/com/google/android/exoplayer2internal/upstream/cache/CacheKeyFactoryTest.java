...
public class CacheKeyFactoryTest {
  ...
  public void default_dataSpecWithKey_returnsKey() {
    ...
    assertThat(CacheKeyFactory.DEFAULT.buildCacheKey(dataSpec)).isEqualTo(key);
  }
  ...
  public void default_dataSpecWithoutKey_returnsUri() {
    ...
    assertThat(CacheKeyFactory.DEFAULT.buildCacheKey(dataSpec)).isEqualTo(testUri.toString());
  }
}
