...
public class MetadataRetrieverTest {
  ...
  public void retrieveMetadata_multipleMediaItems() throws Exception {
    ...
    ListenableFuture<TrackGroupArray> trackGroupsFuture1 = MetadataRetriever.retrieveMetadata(context, mediaItem1);
    ListenableFuture<TrackGroupArray> trackGroupsFuture2 = MetadataRetriever.retrieveMetadata(context, mediaItem2);
