...
public final class TtmlStyleTest {
  ...
  public void inheritStyle() {
    ...
    assertWithMessage("rubyType should not be inherited")
        ...
        .isEqualTo(TtmlStyle.UNSPECIFIED);
  ...
  public void fontSizeUnit() {
    ...
    assertThat(style.getFontSizeUnit()).isEqualTo(TtmlStyle.UNSPECIFIED);
  ...
  public void rubyType() {
    ...
    assertThat(style.getRubyType()).isEqualTo(TtmlStyle.UNSPECIFIED);
