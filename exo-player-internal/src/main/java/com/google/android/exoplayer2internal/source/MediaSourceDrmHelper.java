...
import com.google.android.exoplayer2internal.drm.FrameworkMediaDrm;
import com.google.android.exoplayer2internal.drm.HttpMediaDrmCallback;
import com.google.android.exoplayer2internal.upstream.DefaultHttpDataSourceFactory;
...
import static com.google.android.exoplayer2internal.drm.DefaultDrmSessionManager.MODE_PLAYBACK;
  ...
  public DrmSessionManager create(MediaItem mediaItem) {
    ...
    HttpDataSource.Factory dataSourceFactory =
        drmHttpDataSourceFactory != null
            ...
            : new DefaultHttpDataSourceFactory(userAgent != null ? userAgent : ExoPlayerLibraryInfo.DEFAULT_USER_AGENT);
    HttpMediaDrmCallback httpDrmCallback =
        new HttpMediaDrmCallback(
            Util.castNonNull(drmConfiguration.licenseUri).toString(),
