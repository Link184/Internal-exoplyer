 ...
 */
package com.google.android.exoplayer2internal.extractor;

import android.net.Uri;

import androidx.annotation.Nullable;

import com.google.android.exoplayer2internal.extractor.amr.AmrExtractor;
import com.google.android.exoplayer2internal.extractor.flac.FlacExtractor;
import com.google.android.exoplayer2internal.extractor.flv.FlvExtractor;
import com.google.android.exoplayer2internal.extractor.mkv.MatroskaExtractor;
import com.google.android.exoplayer2internal.extractor.mp3.Mp3Extractor;
import com.google.android.exoplayer2internal.extractor.mp4.FragmentedMp4Extractor;
import com.google.android.exoplayer2internal.extractor.mp4.Mp4Extractor;
import com.google.android.exoplayer2internal.extractor.ogg.OggExtractor;
import com.google.android.exoplayer2internal.extractor.ts.Ac3Extractor;
import com.google.android.exoplayer2internal.extractor.ts.Ac4Extractor;
import com.google.android.exoplayer2internal.extractor.ts.AdtsExtractor;
import com.google.android.exoplayer2internal.extractor.ts.DefaultTsPayloadReaderFactory;
import com.google.android.exoplayer2internal.extractor.ts.PsExtractor;
import com.google.android.exoplayer2internal.extractor.ts.TsExtractor;
import com.google.android.exoplayer2internal.extractor.ts.TsPayloadReader;
import com.google.android.exoplayer2internal.extractor.wav.WavExtractor;
import com.google.android.exoplayer2internal.util.FileTypes;
...
import static com.google.android.exoplayer2internal.util.FileTypes.inferFileTypeFromResponseHeaders;
import static com.google.android.exoplayer2internal.util.FileTypes.inferFileTypeFromUri;
  ...
  static {
    ...
    try {
      ...
      boolean isFlacNativeLibraryAvailable =
          Boolean.TRUE.equals(
              Class.forName("com.google.android.exoplayer2internal.ext.flac.FlacLibrary")
                  .getMethod("isAvailable")
                  .invoke(/* obj= */ null));
      if (isFlacNativeLibraryAvailable) {
        flacExtensionExtractorConstructor =
            Class.forName("com.google.android.exoplayer2internal.ext.flac.FlacExtractor")
