...
public final class CacheDataSink implements DataSink {
  ...
  public void write(byte[] buffer, int offset, int length) throws CacheDataSinkException {
    ...
    try {
      ...
      while (bytesWritten < length) {
        ...
        Util.castNonNull(outputStream).write(buffer, offset + bytesWritten, bytesToWrite);
  ...
  private void openNextOutputStream(DataSpec dataSpec) throws IOException {
    ...
    file =
        cache.startFile(
            Util.castNonNull(dataSpec.key), dataSpec.position + dataSpecBytesWritten, length);
  ...
  private void closeCurrentOutputStream() throws IOException {
    ...
    try {
      ...
      outputStream = null;
      File fileToCommit = Util.castNonNull(file);
      file = null;
      if (success) {
