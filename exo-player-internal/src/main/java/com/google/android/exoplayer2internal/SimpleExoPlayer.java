...
import com.google.android.exoplayer2internal.analytics.AnalyticsCollector;
import com.google.android.exoplayer2internal.analytics.AnalyticsListener;
import com.google.android.exoplayer2internal.audio.AudioAttributes;
import com.google.android.exoplayer2internal.audio.AudioListener;
import com.google.android.exoplayer2internal.audio.AudioRendererEventListener;
import com.google.android.exoplayer2internal.audio.AuxEffectInfo;
import com.google.android.exoplayer2internal.decoder.DecoderCounters;
import com.google.android.exoplayer2internal.device.DeviceInfo;
import com.google.android.exoplayer2internal.device.DeviceListener;
import com.google.android.exoplayer2internal.extractor.DefaultExtractorsFactory;
import com.google.android.exoplayer2internal.extractor.ExtractorsFactory;
import com.google.android.exoplayer2internal.metadata.Metadata;
import com.google.android.exoplayer2internal.metadata.MetadataOutput;
...
import com.google.android.exoplayer2internal.source.ShuffleOrder;
import com.google.android.exoplayer2internal.source.TrackGroupArray;
import com.google.android.exoplayer2internal.text.Cue;
import com.google.android.exoplayer2internal.text.TextOutput;
import com.google.android.exoplayer2internal.trackselection.DefaultTrackSelector;
import com.google.android.exoplayer2internal.trackselection.TrackSelectionArray;
import com.google.android.exoplayer2internal.trackselection.TrackSelector;
import com.google.android.exoplayer2internal.upstream.BandwidthMeter;
import com.google.android.exoplayer2internal.upstream.DefaultBandwidthMeter;
import com.google.android.exoplayer2internal.util.Assertions;
import com.google.android.exoplayer2internal.util.Clock;
import com.google.android.exoplayer2internal.util.Log;
import com.google.android.exoplayer2internal.util.PriorityTaskManager;
import com.google.android.exoplayer2internal.util.Util;
import com.google.android.exoplayer2internal.video.VideoDecoderOutputBufferRenderer;
import com.google.android.exoplayer2internal.video.VideoFrameMetadataListener;
import com.google.android.exoplayer2internal.video.VideoRendererEventListener;
import com.google.android.exoplayer2internal.video.spherical.CameraMotionListener;
...
public class SimpleExoPlayer extends BasePlayer
  ...
  /** @deprecated Use {@link com.google.android.exoplayer2internal.video.VideoListener}. */
  @Deprecated
  public interface VideoListener extends com.google.android.exoplayer2internal.video.VideoListener {}
  ...
  private final CopyOnWriteArraySet<com.google.android.exoplayer2internal.video.VideoListener>
      videoListeners;
  ...
  @Override
  public void addVideoListener(com.google.android.exoplayer2internal.video.VideoListener listener) {
    // Don't verify application thread. We allow calls to this method from any thread.
    Assertions.checkNotNull(listener);
  ...
  @Override
  public void removeVideoListener(com.google.android.exoplayer2internal.video.VideoListener listener) {
    // Don't verify application thread. We allow calls to this method from any thread.
   ...
   * @deprecated Use {@link #addVideoListener(com.google.android.exoplayer2internal.video.VideoListener)}.
   */
  @Deprecated
  ...
  /**
   * Equivalent to {@link #removeVideoListener(com.google.android.exoplayer2internal.video.VideoListener)}.
   *
   * @param listener The listener to clear.
   * @deprecated Use {@link
   *     #removeVideoListener(com.google.android.exoplayer2internal.video.VideoListener)}.
   */
  @Deprecated
  @SuppressWarnings("deprecation")
  ...
  private void maybeNotifySurfaceSizeChanged(int width, int height) {
    if (width != surfaceWidth || height != surfaceHeight) {
      ...
      for (com.google.android.exoplayer2internal.video.VideoListener videoListener : videoListeners) {
