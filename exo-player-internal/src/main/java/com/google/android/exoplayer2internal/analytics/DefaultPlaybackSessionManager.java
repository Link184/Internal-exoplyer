...
import com.google.android.exoplayer2internal.analytics.AnalyticsListener.EventTime;
    ...
    if (eventTime.mediaPeriodId != null && eventTime.mediaPeriodId.isAd()) {
      ...
      if (!contentSession.isCreated) {
        ...
        long adGroupPositionMs =
            C.usToMs(period.getAdGroupTimeUs(eventTime.mediaPeriodId.adGroupIndex))
