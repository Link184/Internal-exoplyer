...
import com.google.android.exoplayer2internal.MediaItem;
...
import com.google.android.exoplayer2internal.source.MediaSource.MediaSourceCaller;
...
import com.google.android.exoplayer2internal.source.chunk.MediaChunk;
import com.google.android.exoplayer2internal.source.chunk.MediaChunkIterator;
import com.google.android.exoplayer2internal.trackselection.BaseTrackSelection;
import com.google.android.exoplayer2internal.trackselection.DefaultTrackSelector;
import com.google.android.exoplayer2internal.trackselection.MappingTrackSelector;
import com.google.android.exoplayer2internal.trackselection.TrackSelection;
import com.google.android.exoplayer2internal.trackselection.TrackSelectorResult;
...
public final class DownloadHelper {
  ...
  public static DownloadHelper forMediaItem(Context context, MediaItem mediaItem) {
    Assertions.checkArgument(isProgressive(Assertions.checkNotNull(mediaItem.playbackProperties)));
    return forMediaItem(
        mediaItem,
        getDefaultTrackSelectorParameters(context),
  ...
  public static DownloadHelper forMediaItem(
      ...
      @Nullable DataSource.Factory dataSourceFactory,
      @Nullable DrmSessionManager drmSessionManager) {
    boolean isProgressive = isProgressive(Assertions.checkNotNull(mediaItem.playbackProperties));
